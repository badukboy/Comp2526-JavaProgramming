...
public class RentalAgreement {
	...
	public RentalAgreement(Customer customer, GregorianCalendar date, MusicalInstrument instrumentRented, 
			double dailyRent, int rentDays, double totalRent) {
		this.customer = customer;
		this.rentalDate = date;
		this.instrumentRented = instrumentRented;
		this.rentalFeePerDay = dailyRent;
		this.numberOfDaysRented = rentDays;
		this.totalRentalFee = totalRent;
	}
