...
public class MusicalInstrument {
	...
	public MusicalInstrument(String desc, String stockC, int stockQty, int soldQty, double pPrice, double sPrice, int numRented) {
		this.quantityInStock = 0;
		this.quantitySold = 0;
		this.purchasePrice = 0;
		this.sellingPrice = 0;
		...
		if(pPrice >= 1 && sPrice >= 1) {
			...
			if(sPrice/pPrice >= 1.1){
				this.description = desc;
				this.stockCode = stockC;
				this.quantityInStock = stockQty;
				this.quantitySold = soldQty;
	...
	public void itemPurchased (int qty) {
